<!doctype html>
<!--[if lt IE 7 ]> <html class="no-js ie6" lang="[(manager_language)]"> <![endif]-->
<!--[if IE 7 ]>    <html class="no-js ie7" lang="[(manager_language)]"> <![endif]-->
<!--[if IE 8 ]>    <html class="no-js ie8" lang="[(manager_language)]"> <![endif]-->
<!--[if (gte IE 9)|!(IE)]><!--> <html class="no-js" lang="[(manager_language)]"> <!--<![endif]-->
<head>
